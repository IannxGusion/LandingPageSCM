      ...
      <div className="p-6">
        <div className="flex justify-between items-center mb-6">
          <button
            ...
            aria-label="Cetak laporan pengiriman"
          >
            Cetak Laporan
          </button>
        </div>
                ...
                return (
                  ...
                  >
                    <div className="flex justify-between items-start mb-2">
                      <div>
                        <div className="font-semibold text-lg text-blue-800 dark:text-blue-400">{namaPembeli}</div>
                      ...
                      <div className="text-right">
                        ...
                        <div className="text-sm font-semibold text-green-700 dark:text-green-400">{totalText}</div>
                        <div className="flex gap-2 justify-end mt-2 print:hidden">
                          <button
                            onClick={() => alert('Fitur edit belum diimplementasikan')}
                            className="text-blue-600 hover:underline text-sm"
                            aria-label={`Edit laporan ${namaPembeli}`}
                          >
                            Edit
                          </button>
                          <button
                            ...
                            aria-label={`Hapus laporan ${namaPembeli}`}
                          >
                            Hapus
                          </button>
                        </div>
